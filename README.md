...
- **oracle-monitor.sh** — 427-line health monitoring system with 10 automated checks, Discord webhook alerting, state-file logic to prevent alert spam, and degraded consensus detection. Runs on cron every 5 minutes on my oracle VPS.
